...
func get_pieces_in_board() -> Array[ChessPiece]:
	var pieces_in_board: Array[ChessPiece] = pieces.filter(func(i: ChessPiece): return i.in_square())
	return pieces_in_board

func get_pieces_not_in_board() -> Array[ChessPiece]:
	var pieces_not_in_board: Array[ChessPiece] = pieces.filter(func(i: ChessPiece): return not i.in_square())
